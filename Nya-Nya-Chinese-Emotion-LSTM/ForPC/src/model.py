...
def load_model(model_path, sava_path=True, vocab_size=None, embedding_dim=None, hidden_dim=None, num_layers=None, find_best=False):
    ...
    model = Nya_Nya_ChineseEmotionLSTM(
    ...
    print(f"模型参数: vocab={checkpoint['vocab_size']}, embedding={checkpoint['embedding_dim']}, "
          f"hidden={checkpoint['hidden_dim']}, layers={checkpoint['num_layers']}")
    print('-' * 40)

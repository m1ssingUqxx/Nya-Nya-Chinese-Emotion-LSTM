    ...
    for batch_size in BATCH_SIZES:
        for lr in LRS:
            for epoch in EPOCHS:
                ...
                }, MODELS_DIR / f'Mobile_model_acc{accuracy:.4f}.pth')

                debug.success(f'已保存模型文件为: {MODELS_DIR}\\Mobile_model_acc{accuracy:.4f}.pth')
                update_js('session_state.json', last_trained_model_name=f'Mobile_model_acc{accuracy:.4f}.pth')

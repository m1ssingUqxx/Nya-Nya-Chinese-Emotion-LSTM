...
# 手机环境
from src.my_tokenizers import Tokenizer, WordLevel as models_WordLevel, WordLevelTrainer as trainers_WordLevelTrainer
# 伪装成层级结构
class models: WordLevel = models_WordLevel
class trainers: WordLevelTrainer = trainers_WordLevelTrainer
